/*global history */
sap.ui.define([
	"nl/stedin/apps/somain/controller/BaseController",
	...
	return BaseController.extend("nl.stedin.apps.somain.controller.Master", {
		...
		onSearch: function(oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("BestelNummer", FilterOperator.Contains, sQuery)];
			} else {
		...
		onOpenViewSettings: function() {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("nl.stedin.apps.somain.view.ViewSettingsDialog", this);
		...
		_onMasterMatched: function() {
			this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
				function(mParams) {
					...
					var sObjectId = mParams.firstListitem.getBindingContext().getProperty("BestelNummer");
		...
		_showDetail: function(oItem) {
			...
			this.getRouter().navTo("object", {
				objectId: oItem.getBindingContext().getProperty("BestelNummer")
			}, bReplace);
		},
