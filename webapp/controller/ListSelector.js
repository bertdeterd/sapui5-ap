sap.ui.define([
	...
	return BaseObject.extend("nl.stedin.apps.somain.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias nl.stedin.apps.somain.model.ListSelector
		 */
		 ...
		 * @return {nl.stedin.apps.somain.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
