sap.ui.define([
	...
	"sap/ui/Device",
	"nl/stedin/apps/somain/model/models",
	"nl/stedin/apps/somain/controller/ListSelector",
	"nl/stedin/apps/somain/controller/ErrorHandler",
	"nl/stedin/apps/somain/model/formatter"
], function(UIComponent, Device, models, ListSelector, ErrorHandler) {
	"use strict";

	return UIComponent.extend("nl.stedin.apps.somain.Component", {

		metadata: {
			"version": "1.0.0",
			"rootView": {
				"viewName": "nl.stedin.apps.somain.view.App",
				"type": "XML",
				"id": "app"
			},
			"dependencies": {
			...
			"config": {
				"i18nBundle": "nl.stedin.apps.somain.i18n.i18n",
			...
			"routing": {
				"config": {
					...
					"viewType": "XML",
					"viewPath": "nl.stedin.apps.somain.view",
