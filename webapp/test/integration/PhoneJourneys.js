...
jQuery.sap.require("nl.stedin.apps.somain.test.integration.NavigationJourneyPhone");
jQuery.sap.require("nl.stedin.apps.somain.test.integration.NotFoundJourneyPhone");
jQuery.sap.require("nl.stedin.apps.somain.test.integration.BusyJourneyPhone");