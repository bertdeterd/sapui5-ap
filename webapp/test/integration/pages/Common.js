sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("nl/stedin/apps/somain/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#SalesOrderStedinTitle-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#SalesOrderStedinTitle-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("nl.stedin.apps.somain.test.integration.pages.Common", {
		...
		getMockServer: function() {
			return new Promise(function(success) {
				Opa5.getWindow().sap.ui.require(["nl/stedin/apps/somain/localService/mockserver"], function(mockserver) {
