								...
								success: function(oList) {
									var aItemsNotInTheList = aEntityData.filter(function(oObject) {
										return !oList.getItems().some(function(oListItem) {
											return oListItem.getBindingContext().getProperty("SALESORDERNUMBER") === oObject.SALESORDERNUMBER;
										});
									});
									...
									this.getContext().currentId = aItemsNotInTheList[0].SALESORDERNUMBER;
								},
			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function() {
					return this.waitFor({
						...
						success: function() {
							QUnit.ok(true, "The list header displays 'SalesOrders (0)'");
						},
				...
				theListShouldBeSortedAscendingOnName: function() {
					return this.theListShouldBeSortedAscendingOnField("SALESORDERNUMBER");
				},
					...
					return this.waitFor({
						...
						success: function(oList) {
							...
							this.waitFor({
								...
								matchers: new PropertyStrictEquals({
									name: "title",
									value: "SalesOrders (" + iExpectedLength + ")"
								}),
								success: function() {
